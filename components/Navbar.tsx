            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Link
                    href={item.href}
                    className={`relative flex items-center justify-center rounded-lg px-2 py-1.5 text-sm font-medium transition-[color,background-color,transform] duration-200 active:scale-[0.97] sm:px-4 sm:py-2 sm:text-lg ${
                      isActive
                        ? colors.active
