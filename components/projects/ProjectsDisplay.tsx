                  ...
                  <li key={technology._id} className="relative w-8 h-8 mt-4">
                    <span className="group">
                      <Image
                        ...
                        priority
                      />
                      <span className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 w-max p-1 group-hover:inline hidden bg-transparent backdrop-blur opacity-100 border-2 border-sky-300/75 rounded-md shadow-lg text-white text-sm">
                        {technology.name}
                      </span>
                    </span>
                  </li>
